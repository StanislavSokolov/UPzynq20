...
HD_PWD='D:/Projects/XilinxProjects/UPzynq20_test/UPzynq20_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UPzynq20_test_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UPzynq20_test_design_wrapper.tcl
