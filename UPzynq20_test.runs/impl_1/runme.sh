...
HD_PWD='D:/Projects/XilinxProjects/UPzynq20_test/UPzynq20_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log UPzynq20_test_design_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source UPzynq20_test_design_wrapper.tcl -notrace
