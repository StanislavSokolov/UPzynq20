...
HD_PWD='D:/Projects/XilinxProjects/UPzynq20_test/UPzynq20_test.runs/UPzynq20_test_design_IP_AXI_ADC_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UPzynq20_test_design_IP_AXI_ADC_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UPzynq20_test_design_IP_AXI_ADC_0_0.tcl
