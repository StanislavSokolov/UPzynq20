...
void set_initial_values_control_transistor_keys(){
		Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + 22*coef, 0x00000000);				// «акрыть все ключи IP_AXI_PWM (PWMstarting)
		Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR, 0x0000000B);

		Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 1*coef, 0x0000FFFF);			// –азрешение работы тормозных резисторов
	...
	//	Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 7*coef, 0x00000000);			// маска на выходе Inverter_3lvl_wrapper_0 (MaskMinTimeErrorGroup2 - резерв) - избыточна
		Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 8*coef, 0x00000000);			// врем€ Inverter_3lvl_wrapper_0 (DeadTimeGroup0)
	//	Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 9*coef, 0x00000000);			// врем€ Inverter_3lvl_wrapper_0 (DeadTimeGroup1 - резерв)
		Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 10*coef, 0x00000000);			// врем€ Inverter_3lvl_wrapper_0 (MinTimeGroup0)
	//	Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 11*coef, 0x00000000);			// врем€ Inverter_3lvl_wrapper_0 (MinTimeGroup1 - резерв)
		Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 12*coef, 0x00000000);			// активаци€ защиты по ответу AckChecker_wrapper_0 (AcknowledgeProtectionEnableGroup0)
	//	Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 13*coef, 0x00000000);			// активаци€ защиты по ответу AckChecker_wrapper_0 (AcknowledgeProtectionEnableGroup1 - резерв)
	//	Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 14*coef, 0x00000000);			// активаци€ защиты по ответу AckChecker_wrapper_0 (AcknowledgeProtectionEnableGroup2 - резерв) - избыточна
		Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 15*coef, 0x00000000);			// активаци€ токовой защиты AckChecker_wrapper_0 (CurrentProtectionEnableGroup0)
	//	Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 16*coef, 0x00000000);			// активаци€ токовой защиты AckChecker_wrapper_0 (CurrentProtectionEnableGroup1 - резерв)
	//	Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 17*coef, 0x00000000);			// активаци€ токовой защиты AckChecker_wrapper_0 (CurrentProtectionEnableGroup2 - резерв) - избыточна
	...
	//	Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 23*coef, 0x00000000);			// маска токовой защиты AckChecker_wrapper_0 (MaskCurrentGroup2 - резерв) - избыточна
		Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 24*coef, 0x00000000);			// врем€ AckChecker_wrapper_0 (AcknowledgeTimeGroup0)
	//	Xil_Out32(XPAR_IP_AXI_INVERTER_0_S00_AXI_BASEADDR + 25*coef, 0x00000000);			// врем€ AckChecker_wrapper_0 (AcknowledgeTimeGroup1 - резерв) - избыточна
		...
		for (int i = 0; i < 16; i++) {
			Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + i*coef, 0x00000000);			// нулевые значени€ счетчиков дл€ IP_AXI_PWM (регистры 0-15)
		}

		Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + 16*coef, 0x00000000);				// направление пилы дл€ IP_AXI_PWM (PWMdirection)
		Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + 17*coef, 0x00000000);				// счетчик пилы дл€ IP_AXI_PWM (PWMcounterMax)
		Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + 18*coef, 0x00000000);				// источник Ў»ћј дл€ IP_AXI_PWM (PWMsource) 0 - Ў»ћ от генератора IP_AXI_PWM, 1 - Ў»ћ из регистра, предназначенного дл€ Ў»ћ контроллера, 2 - пр€мое управление ключами из соответствующего регистра
		Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + 19*coef, 0x00000000);				// Ў»ћ от контроллера дл€ IP_AXI_PWM (PWMfromCPU) - обнуление задани€
		Xil_Out32(XPAR_IP_AXI_PWM_0_S00_AXI_BASEADDR + 20*coef, 0x00000000);				// пр€мое управление ключами (PWMrightControl) - обнуление задани€
		//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
}
