...
int main () 
{
...

   {
      ...
      print("\r\nRunning GpioInputExample() for axi_gpio_3...\r\n");

      u32 DataRead;
      
      status = GpioInputExample(XPAR_AXI_GPIO_3_DEVICE_ID, &DataRead);
...

   {
      ...
      status = GpioOutputExample(XPAR_AXI_GPIO_4_DEVICE_ID,16);
...

   {
      ...
      status = GpioOutputExample(XPAR_AXI_GPIO_5_DEVICE_ID,16);
...

   {
      ...
      print("\r\nRunning GpioOutputExample() for axi_gpio_6...\r\n");

      status = GpioOutputExample(XPAR_AXI_GPIO_6_DEVICE_ID,16);
...

   {
      ...
      print("\r\nRunning GpioInputExample() for axi_gpio_7...\r\n");

      u32 DataRead;
      
      status = GpioInputExample(XPAR_AXI_GPIO_7_DEVICE_ID, &DataRead);
