...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = IP_AXI_LEDS
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = IP_AXI_LEDS_1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = IP_AXI_LEDS
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = IP_AXI_LEDS_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = IP_AXI_ParallelBus
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = IP_AXI_ParallelBus_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = IP_AXI_LedController
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = IP_AXI_LedController_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = IP_AXI_SerialBus
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = IP_AXI_SerialBus_0
END
