...
HD_PWD='d:/gitea/upzynq20_test/upzynq20_test.tmp/ip_axi_adc_v1_0_project/IP_AXI_ADC_v1_0_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_AXI_ADC_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IP_AXI_ADC_v1_0.tcl -notrace
