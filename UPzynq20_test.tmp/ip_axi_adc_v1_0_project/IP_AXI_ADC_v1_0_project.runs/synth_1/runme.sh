...
HD_PWD='d:/gitea/upzynq20_test/upzynq20_test.tmp/ip_axi_adc_v1_0_project/IP_AXI_ADC_v1_0_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_AXI_ADC_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IP_AXI_ADC_v1_0.tcl
