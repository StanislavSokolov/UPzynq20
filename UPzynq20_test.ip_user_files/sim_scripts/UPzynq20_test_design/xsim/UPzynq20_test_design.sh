...
#
# Generated by Vivado on Fri Sep 10 12:12:08 +0300 2021
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L generic_baseblocks_v2_1_0 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_19 -L fifo_generator_v13_2_4 -L axi_data_fifo_v2_1_18 -L axi_crossbar_v2_1_20 -L xil_defaultlib -L axi_vip_v1_1_5 -L processing_system7_vip_v1_0_7 -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_2 -L interrupt_control_v3_1_4 -L axi_gpio_v2_0_21 -L proc_sys_reset_v5_0_13 -L xlconcat_v2_1_3 -L axi_protocol_converter_v2_1_19 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot UPzynq20_test_design xil_defaultlib.UPzynq20_test_design xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim UPzynq20_test_design -key {Behavioral:sim_1:Functional:UPzynq20_test_design} -tclbatch cmd.tcl -protoinst "protoinst_files/AckChecker.protoinst" -protoinst "protoinst_files/Inverter_3lvl.protoinst" -protoinst "protoinst_files/UPzynq20_test_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb UPzynq20_test_design.wdb xsim.dir)
