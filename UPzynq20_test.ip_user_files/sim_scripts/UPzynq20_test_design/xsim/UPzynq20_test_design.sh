...
simulate()
{
  xsim UPzynq20_test_design -key {Behavioral:sim_1:Functional:UPzynq20_test_design} -tclbatch cmd.tcl -protoinst "protoinst_files/Inverter_3lvl.protoinst" -protoinst "protoinst_files/AckChecker.protoinst" -protoinst "protoinst_files/UPzynq20_test_design.protoinst" -log simulate.log
}
