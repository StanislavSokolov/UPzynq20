...
compile()
{
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    ...
    "$ref_dir/../../../bd/UPzynq20_test_design/ipshared/9c69/hdl/IP_AXI_OpticalBus_v1_0_S00_AXI.vhd" \
    "$ref_dir/../../../bd/UPzynq20_test_design/ipshared/9c69/hdl/IP_AXI_OpticalBus_v1_0.vhd" \
