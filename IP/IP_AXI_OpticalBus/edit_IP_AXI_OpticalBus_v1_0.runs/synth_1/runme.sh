...
HD_PWD='d:/gitea/upzynq20_test/ip/ip_axi_opticalbus/edit_IP_AXI_OpticalBus_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_AXI_OpticalBus_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IP_AXI_OpticalBus_v1_0.tcl
