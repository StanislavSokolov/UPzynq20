...
HD_PWD='d:/gitea/upzynq20_test/ip/ip_axi_opticalbus/edit_IP_AXI_OpticalBus_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log IP_AXI_OpticalBus_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source IP_AXI_OpticalBus_v1_0.tcl -notrace
