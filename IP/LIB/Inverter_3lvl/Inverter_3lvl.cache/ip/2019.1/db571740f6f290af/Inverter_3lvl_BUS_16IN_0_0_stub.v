...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(BusBlock16IN, Enable, Out0, Out1, Out2, Out3, Out4, 
  Out5, Out6, Out7, Out8, Out9, Out10, Out11, Out12, Out13, Out14, Out15)
/* synthesis syn_black_box black_box_pad_pin="BusBlock16IN[15:0],Enable,Out0,Out1,Out2,Out3,Out4,Out5,Out6,Out7,Out8,Out9,Out10,Out11,Out12,Out13,Out14,Out15" */;
