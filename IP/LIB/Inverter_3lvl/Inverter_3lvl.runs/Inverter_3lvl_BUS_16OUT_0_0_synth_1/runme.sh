...
HD_PWD='D:/Projects/IP/LIB/Inverter_3lvl/Inverter_3lvl.runs/Inverter_3lvl_BUS_16OUT_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Inverter_3lvl_BUS_16OUT_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Inverter_3lvl_BUS_16OUT_0_0.tcl
