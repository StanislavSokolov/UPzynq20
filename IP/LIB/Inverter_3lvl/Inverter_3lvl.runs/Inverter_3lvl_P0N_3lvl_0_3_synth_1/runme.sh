...
HD_PWD='D:/GITEA/UPzynq20_test/IP/LIB/Inverter_3lvl/Inverter_3lvl.runs/Inverter_3lvl_P0N_3lvl_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Inverter_3lvl_P0N_3lvl_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Inverter_3lvl_P0N_3lvl_0_3.tcl
