...
HD_PWD='D:/Projects/IP/LIB/Inverter_3lvl/Inverter_3lvl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Inverter_3lvl_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Inverter_3lvl_wrapper.tcl -notrace
