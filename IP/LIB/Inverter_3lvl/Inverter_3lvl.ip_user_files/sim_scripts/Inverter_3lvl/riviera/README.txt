...
#
# Generated by export_simulation on Fri Jun 11 07:49:00 +0300 2021
#
################################################################################
...
'-reset_run' switch to the './Inverter_3lvl.sh' script.

./Inverter_3lvl.sh -reset_run
...
./Inverter_3lvl.sh -noclean_files

For more information on the script, please type './Inverter_3lvl.sh -help'.
