...
HD_PWD='D:/Projects/IP/LIB/BusBlock16IN/BusBlock16IN.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BusBlock16IN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BusBlock16IN.tcl
