...
HD_PWD='D:/Projects/IP/LIB/BusBlock16IN/BusBlock16IN.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BusBlock16IN.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BusBlock16IN.tcl -notrace
