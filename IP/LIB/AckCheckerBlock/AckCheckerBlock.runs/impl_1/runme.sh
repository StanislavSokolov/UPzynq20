...
HD_PWD='D:/Projects/IP/LIB/AckCheckerBlock/AckCheckerBlock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AckChecker_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AckChecker_wrapper.tcl -notrace
