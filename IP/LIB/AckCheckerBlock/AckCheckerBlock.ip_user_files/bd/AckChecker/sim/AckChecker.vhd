...
architecture STRUCTURE of AckChecker is
  ...
  signal NLW_BusBlock16OUT_1_Bus_16OUT_UNCONNECTED : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal NLW_BusBlock16OUT_2_Bus_16OUT_UNCONNECTED : STD_LOGIC_VECTOR ( 15 downto 0 );
...
begin
  ...
  reset_0_1 <= reset_0;
  AcknowledgeErrorGroup1(0) <= 'Z';
  AcknowledgeErrorGroup1(1) <= 'Z';
  AcknowledgeErrorGroup1(2) <= 'Z';
  AcknowledgeErrorGroup1(3) <= 'Z';
  AcknowledgeErrorGroup1(4) <= 'Z';
  AcknowledgeErrorGroup1(5) <= 'Z';
  AcknowledgeErrorGroup1(6) <= 'Z';
  AcknowledgeErrorGroup1(7) <= 'Z';
  AcknowledgeErrorGroup1(8) <= 'Z';
  AcknowledgeErrorGroup1(9) <= 'Z';
  AcknowledgeErrorGroup1(10) <= 'Z';
  AcknowledgeErrorGroup1(11) <= 'Z';
  AcknowledgeErrorGroup1(12) <= 'Z';
  AcknowledgeErrorGroup1(13) <= 'Z';
  AcknowledgeErrorGroup1(14) <= 'Z';
  AcknowledgeErrorGroup1(15) <= 'Z';
  CurrentErrorGroup1(0) <= 'Z';
  CurrentErrorGroup1(1) <= 'Z';
  CurrentErrorGroup1(2) <= 'Z';
  CurrentErrorGroup1(3) <= 'Z';
  CurrentErrorGroup1(4) <= 'Z';
  CurrentErrorGroup1(5) <= 'Z';
  CurrentErrorGroup1(6) <= 'Z';
  CurrentErrorGroup1(7) <= 'Z';
  CurrentErrorGroup1(8) <= 'Z';
  CurrentErrorGroup1(9) <= 'Z';
  CurrentErrorGroup1(10) <= 'Z';
  CurrentErrorGroup1(11) <= 'Z';
  CurrentErrorGroup1(12) <= 'Z';
  CurrentErrorGroup1(13) <= 'Z';
  CurrentErrorGroup1(14) <= 'Z';
  CurrentErrorGroup1(15) <= 'Z';
...
BusBlock16IN_1: component AckChecker_BusBlock16IN_0_1
     port map (
      Bus_16IN(15 downto 0) => B"0000000000000000",
...
BusBlock16OUT_1: component AckChecker_BusBlock16OUT_0_1
     port map (
      Bus_16OUT(15 downto 0) => NLW_BusBlock16OUT_1_Bus_16OUT_UNCONNECTED(15 downto 0),
...
BusBlock16OUT_2: component AckChecker_BusBlock16OUT_0_2
     port map (
      Bus_16OUT(15 downto 0) => NLW_BusBlock16OUT_2_Bus_16OUT_UNCONNECTED(15 downto 0),
