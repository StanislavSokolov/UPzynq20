...
proc create_root_design { parentCell } {
  ...
  set OUT_put_Dif_1 [ create_bd_port -dir O OUT_put_Dif_1 ]

  # Create instance: DifferentialSignal_0, and set properties
  set DifferentialSignal_0 [ create_bd_cell -type ip -vlnv setcorp:user:DifferentialSignal:1.0 DifferentialSignal_0 ]

  # Create instance: DifferentialSignal_1, and set properties
  set DifferentialSignal_1 [ create_bd_cell -type ip -vlnv setcorp:user:DifferentialSignal:1.0 DifferentialSignal_1 ]
  ...
  # Create instance: IP_AXI_LEDS_1, and set properties
  set IP_AXI_LEDS_1 [ create_bd_cell -type ip -vlnv ssevendenergy.com:user:IP_AXI_LEDS:1.0 IP_AXI_LEDS_1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ENET1_PERIPHERAL_DIVISOR0 {16} \
   ...
   CONFIG.PCW_MIO_TREE_PERIPHERALS {GPIO#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#GPIO#GPIO#GPIO#UART 0#UART 0#GPIO#GPIO#CAN 0#CAN 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 0#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#Enet 1#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO#GPIO#GPIO#GPIO#GPIO#GPIO#UART 1#UART 1} \
   CONFIG.PCW_MIO_TREE_SIGNALS {gpio[0]#qspi0_ss_b#qspi0_io[0]#qspi0_io[1]#qspi0_io[2]#qspi0_io[3]/HOLD_B#qspi0_sclk#gpio[7]#gpio[8]#gpio[9]#rx#tx#gpio[12]#gpio[13]#rx#tx#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#tx_clk#txd[0]#txd[1]#txd[2]#txd[3]#tx_ctl#rx_clk#rxd[0]#rxd[1]#rxd[2]#rxd[3]#rx_ctl#clk#cmd#data[0]#data[1]#data[2]#data[3]#gpio[46]#gpio[47]#gpio[48]#gpio[49]#gpio[50]#gpio[51]#tx#rx} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M08_AXI [get_bd_intf_pins axi_gpio_4/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M08_AXI]
